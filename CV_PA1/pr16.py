...
print("upsampled_PSNR : {:.3f}".format(PSNR_upsample))
print("\n")
######################################################################################
...
print("MSE : {:.5f}".format(MSE_list_tast1[index]))
print("\n")
print("#######################################################")
print("\n")
...
gh0 = gh0_org/np.max(gh0_org) + 1e-10              

lap_ih0 = cv2.Laplacian(ih ,ddepth =-1)  


gt = gh0 - lap_ih0/np.max(lap_ih0)  
gt = np.clip(gt,0,1)      
...
alpha_list = np.arange(0.005,0.015,0.001)
...
print("MSE : {:.5f}".format(MSE_list_tast2[index]))
print("\n")
print("#######################################################")
print("\n")
