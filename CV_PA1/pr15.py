...
plt.figure(0)
plt.axis(False)
plt.title("Raw image(upsampled.png)")
plt.imshow(ih)
##plt.savefig('Raw image(upsampled.png).png', bbox_inches='tight',pad_inches = 0)
...
MSE_list_tast1 = []
PSNR_task1_result = []
alpha_list = np.arange(1.3,2.3,0.1)
...
plt.figure(10)
plt.axis(False)
plt.title("Image using method1 of max iteration")
plt.imshow(idt)
##plt.savefig('Image using method1 of max iteration.png', bbox_inches='tight',pad_inches = 0)
plt.show(block=False)

plt.figure(20)
plt.axis(False)
plt.title("Image using method1 of optimal iteration")
plt.imshow(idt_list[index])
##plt.savefig('Image using method1 of optimal iteration.png', bbox_inches='tight',pad_inches = 0)
plt.show(block=False)
...
alpha_list = np.arange(0.008,0.018,0.001)
...
plt.figure(30)
plt.axis(False)
plt.title("Image using method2 of max iteration")
plt.imshow(iht)
##plt.savefig('Image using method2 of max iteration', bbox_inches='tight',pad_inches = 0)
plt.show(block=False)

plt.figure(40)
plt.axis(False)
plt.title("Image using method2 of optimal iteration")
plt.imshow(iht_list[index])
##plt.savefig('Image using method2 of optimal iteration', bbox_inches='tight',pad_inches = 0)
plt.show(block = False)
